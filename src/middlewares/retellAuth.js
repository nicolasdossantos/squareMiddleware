...
async function retellAuthMiddleware(req, res, next) {
  ...
  try {
    ...
    // Use raw body to avoid JSON stringify differences
    ...
    console.log('[RetellAuth] DEBUG - Payload length:', payload.length);
    console.log('[RetellAuth] DEBUG - Payload start:', payload.substring(0, 100));
