...
import { ArrowLeft, ArrowRight, Phone, InfoIcon } from 'lucide-react'
...
const US_AREA_CODES = [
  ...
  '254', '256', '260', '262', '267', '268', '269', '270', '272', '276',
  '281', '283', '301', '302', '303', '304', '305', '306', '307', '308',
  '309', '310', '312', '313', '314', '315', '316', '317', '318', '319',
  '320', '321', '323', '325', '330', '331', '334', '336', '337', '339',
  '346', '347', '351', '352', '360', '361', '362', '369', '371', '380',
  '385', '386', '401', '402', '403', '404', '405', '406', '407', '408',
  '409', '410', '412', '413', '414', '415', '417', '418', '419', '423',
  '424', '425', '428', '430', '431', '432', '434', '435', '440', '441',
  '442', '443', '445', '450', '469', '470', '472', '475', '478', '479',
  '480', '484', '501', '502', '503', '504', '505', '506', '507', '508',
  '509', '510', '512', '513', '514', '515', '516', '517', '518', '519',
  '520', '530', '531', '534', '539', '540', '541', '551', '559', '561',
  '562', '563', '564', '567', '570', '571', '573', '574', '575', '580',
  '581', '585', '586', '601', '602', '603', '604', '605', '606', '607',
  '608', '609', '610', '612', '613', '614', '615', '616', '617', '618',
  '619', '620', '623', '626', '628', '629', '630', '631', '636', '641',
  '646', '650', '651', '657', '659', '660', '661', '662', '667', '669',
  '670', '671', '678', '679', '680', '681', '682', '684', '689', '701',
  '702', '703', '704', '705', '706', '707', '708', '709', '710', '712',
  '713', '714', '715', '716', '717', '718', '719', '720', '721', '724',
  '725', '726', '727', '731', '732', '734', '740', '743', '747', '754',
  '757', '760', '762', '763', '765', '769', '770', '771', '772', '773',
  '774', '775', '776', '778', '779', '780', '781', '782', '785', '786',
  '787', '801', '802', '803', '804', '805', '806', '807', '808', '809',
  '810', '812', '813', '814', '815', '816', '817', '818', '819', '820',
  '825', '828', '830', '831', '832', '833', '835', '838', '843', '845',
  '847', '848', '850', '854', '856', '857', '858', '859', '860', '862',
  '863', '864', '865', '870', '878', '880', '881', '882', '883', '884',
  '885', '886', '901', '902', '903', '904', '905', '906', '907', '908',
  '909', '910', '912', '913', '914', '915', '916', '917', '918', '919',
  '920', '925', '928', '929', '931', '932', '934', '936', '937', '938',
  '940', '941', '942', '944', '945', '947', '948', '949', '951', '952',
  '954', '956', '959', '970', '971', '972', '973', '974', '975', '978',
  '979', '980', '984', '985', '986', '989',
]

export default function PhoneNumberChoicePage({
  theme,
  onToggleTheme,
}: PhoneNumberChoicePageProps) {
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="card space-y-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all duration-200"
                      style={{
